...
@TableName("life_policy_beneficiary")
public class LifePolicyBeneficiary implements Serializable {
    ...
    @TableField("id_no")
    private String idNo;
    @ApiModelProperty(value = "证件类型和证件号码拼接字符串")
    ...
    @ApiModelProperty(value = "受益比例：记录百分比值。100%时存 100")
    @TableField("ratio")
