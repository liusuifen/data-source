...
@TableName("life_policy")
public class LifePolicy implements Serializable {
    ...
    @ApiModelProperty(value = "承保进度10草稿11录单12预收13人工核保14拒保15承保16回执17复核18回访19对账20发佣21积分22自核25撤单")
    @TableField("progress")
    private Integer progress;
    @ApiModelProperty(value = "续费年度")
    @TableField("period")
    private Integer period;
    @ApiModelProperty(value = "1待承保2承保3有效5犹豫期退保6退保7失效8终止")
    @TableField("status")
    ...
    @ApiModelProperty(value = "录单方式 1api对接2手工录单")
    ...
    @ApiModelProperty(value = "主险id")
    @TableField("product_id")
    private Long productId;
    @ApiModelProperty(value = "主险类别id")
    @TableField("product_category_id")
    private Integer productCategoryId;
    @ApiModelProperty(value = "录单人id")
    @TableField("import_user_id")
    private Long importUserId;
    @ApiModelProperty(value = "弃用字段")
    ...
    @ApiModelProperty(value = "修改类型：1：正常保单  2：代理人修改 3：孤儿单修改")
    ...
    @ApiModelProperty(value = "审批状态，1 - 未审批，2 - 审批未通过，3 - 审批通过")
    ...
    @ApiModelProperty(value = "1保险公司合同")
    ...
    @ApiModelProperty(value = "首期佣金计算状态 0-未计算 1-计算失败 2-计算成功")
