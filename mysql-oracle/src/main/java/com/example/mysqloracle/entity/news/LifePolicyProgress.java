...
@TableName("life_policy_progress")
public class LifePolicyProgress implements Serializable {
    ...
    @ApiModelProperty(value = "10草稿11录单12预收13人工核保14拒保15承保16回执17复核18回访19对账20发佣21积分22自核")
    @TableField("progress")
